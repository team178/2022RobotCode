...
def runPipeline(image, llrobot):
    ...
    img_threshold = cv2.inRange(img_hsv, (50, 50, 100), (65, 200, 200))
                                        #dont adjust the first two unless you change the setting on the first page, which are 2,0, 500,500 respectively
