...
public class ArcadeDrive extends CommandBase {
  ...
  @Override
  public void execute() {
    double xaxisSpeed = m_xaxisSpeedSupplier.getAsDouble() * m_drivetrain.getYMult();
    double zaxisSpeed = m_zaxisRotateSuppplier.getAsDouble() * m_drivetrain.getTwistMult();
